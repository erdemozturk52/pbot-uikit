...
var socials = [
    {
        ...
        items: [
            {
                label: "English",
                href: "https://t.me/botswapfinance",
            },
        ],
    },
    {
        label: "Twitter",
        icon: "TwitterIcon",
        href: "https://twitter.com/BotSwapFinance",
    },
];
var MENU_HEIGHT = 64;
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#1C1E21", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#d7dae0", textDisabled: "#BDC2C4", textSubtle: "#7b8088", borderColor: "#E9EAEB", card: "#25272A", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
    
    
    var darkColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#1C1E21", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#eeeaf4", tertiary: "#EFF4F5", text: "#d7dae0", textDisabled: "#BDC2C4", textSubtle: "#7b8088", borderColor: "#E9EAEB", card: "#25272A", gradients: {
        bubblegum: "linear-gradient(139.73deg, #E6FDFF 0%, #F3EFFF 100%)",
    } });
